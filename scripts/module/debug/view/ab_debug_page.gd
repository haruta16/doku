...
@onready var _current_country_value: Label = $CenterPanel / Margin / VBox / CurrentCountryRow / CurrentCountryValue
...
func _on_confirm_pressed() -> void :
    ...
    print("[AbDebugPage] confirm group_id=%s(changed=%s) country=%s(changed=%s) → quit" % [
