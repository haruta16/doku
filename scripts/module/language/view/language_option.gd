...
func set_selected(selected: bool) -> void :
    ...
    _native_label.add_theme_color_override("font_color", _C_SELECTED_TEXT if selected else _C_NORMAL_TEXT)
    _sub_label.add_theme_color_override("font_color", _C_SELECTED_SUB if selected else _C_NORMAL_SUB)
