...
var _DEMOS: Array = [
    ...
    }, 
    {
        ...
        "cross_waves": [
            ...
            {"frame": 92, "cells": [Vector2i(1, 0), Vector2i(1, 1), Vector2i(1, 3), Vector2i(1, 4)]}, 
        ], 
    }, 
    {
        ...
        "cross_waves": [
            {"frame": 72, "cells": [
                Vector2i(2, 1), Vector2i(1, 1), Vector2i(0, 1), Vector2i(0, 2), 
...
func _play_demo(idx: int, token: int) -> bool:
    ...
    for wave: Dictionary in demo["cross_waves"]:
        ...
        for k in range(cells.size()):
            events.append({"frame": base + k * _CROSS_STEP_FRAMES, "cell": cells[k], "anim": _CROSS_ANIM})
