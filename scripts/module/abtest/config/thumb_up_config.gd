...
const _PRIORITY_MAP: Dictionary = {
    ...
    8: [Feedback.CORRECTION_CHEER, Feedback.BLOW_TRUMPET, Feedback.CLAP, Feedback.LIKE, Feedback.MISSED_CAT], 
    9: [Feedback.CORRECTION_CHEER, Feedback.BLOW_TRUMPET, Feedback.CLAP, Feedback.LIKE, Feedback.MISSED_CAT], 
}
