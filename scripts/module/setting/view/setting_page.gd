...
@onready var _sound_ctrl: Control = $Root / Content / PanelContainer / VBoxContainer / GridContainer / SoundCtrl
@onready var _sound_btn: BaseButton = $Root / Content / PanelContainer / VBoxContainer / GridContainer / SoundCtrl / SoundBtn
@onready var _vibration_ctrl: Control = $Root / Content / PanelContainer / VBoxContainer / GridContainer / VibrationCtrl
@onready var _vibration_btn: BaseButton = $Root / Content / PanelContainer / VBoxContainer / GridContainer / VibrationCtrl / VibrationBtn


@onready var _people_ctrl: Control = $Root / Content / PanelContainer / VBoxContainer / GridContainer / PeopleCtrl
@onready var _people_btn: BaseButton = $Root / Content / PanelContainer / VBoxContainer / GridContainer / PeopleCtrl / PeopleBtn
...
@onready var _music_ctrl: Control = $Root / Content / PanelContainer / VBoxContainer / GridContainer / MusicCtrl
@onready var _music_btn: BaseButton = $Root / Content / PanelContainer / VBoxContainer / GridContainer / MusicCtrl / MusicBtn
@onready var _music_toggle_on: Panel = $Root / Content / PanelContainer / VBoxContainer / GridContainer / MusicCtrl / MusicBtn / ToggleOn
@onready var _music_toggle_off: Panel = $Root / Content / PanelContainer / VBoxContainer / GridContainer / MusicCtrl / MusicBtn / ToggleOff
@onready var _sound_toggle_on: Panel = $Root / Content / PanelContainer / VBoxContainer / GridContainer / SoundCtrl / SoundBtn / ToggleOn
@onready var _sound_toggle_off: Panel = $Root / Content / PanelContainer / VBoxContainer / GridContainer / SoundCtrl / SoundBtn / ToggleOff
@onready var _vibration_toggle_on: Panel = $Root / Content / PanelContainer / VBoxContainer / GridContainer / VibrationCtrl / VibrationBtn / ToggleOn
@onready var _vibration_toggle_off: Panel = $Root / Content / PanelContainer / VBoxContainer / GridContainer / VibrationCtrl / VibrationBtn / ToggleOff
@onready var _icon_music: TextureRect = $Root / Content / PanelContainer / VBoxContainer / GridContainer / MusicCtrl / MusicBtn / IconMusic
@onready var _icon_sound: TextureRect = $Root / Content / PanelContainer / VBoxContainer / GridContainer / SoundCtrl / SoundBtn / IconSound
@onready var _icon_vibration: TextureRect = $Root / Content / PanelContainer / VBoxContainer / GridContainer / VibrationCtrl / VibrationBtn / IconVibration
@onready var _people_toggle_on: Panel = $Root / Content / PanelContainer / VBoxContainer / GridContainer / PeopleCtrl / PeopleBtn / ToggleOn
@onready var _people_toggle_off: Panel = $Root / Content / PanelContainer / VBoxContainer / GridContainer / PeopleCtrl / PeopleBtn / ToggleOff
@onready var _icon_people: TextureRect = $Root / Content / PanelContainer / VBoxContainer / GridContainer / PeopleCtrl / PeopleBtn / IconPeople
@onready var _terms_btn: UnderlineLink = $Root / Content / PanelContainer / VBoxContainer / TermContainer / TermsBtn
@onready var _privacy_btn: UnderlineLink = $Root / Content / PanelContainer / VBoxContainer / TermContainer / PrivacyBtn
@onready var _privacy_preference_btn: UnderlineLink = $Root / Content / PanelContainer / VBoxContainer / PrivacyContainer / PrivacyPreferenceBtn
...
@onready var _vb_restart: Control = $Root / Content / PanelContainer / VBoxContainer / BtnContainer / OrangeRestartBtn
@onready var _vb_restart_bg: Button = $Root / Content / PanelContainer / VBoxContainer / BtnContainer / OrangeRestartBtn / Bg
