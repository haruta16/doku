...
@onready var _primary_badge: GameAdBadge = $Root / Content / Label / VBoxContainer / DualBtnArea / PrimaryBtn / Badge
@onready var _ad_icon_box: Control = $Root / Content / Label / VBoxContainer / DualBtnArea / PrimaryBtn / BtnGroup / AdIconBox
...
@onready var _best_record_top_txt: RichTextLabel = $Root / Content / Label / VBoxContainer / LabelArea / BestRecordTopTxt
